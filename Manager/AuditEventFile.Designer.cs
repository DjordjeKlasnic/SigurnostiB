...
namespace Manager {
    ...
    internal class AuditEventFile {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Failed to update database {0].
        /// </summary>
        internal static string UpdateDatabaseFailure {
            get {
                return ResourceManager.GetString("UpdateDatabaseFailure", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Successfull update on the database {0}.
        /// </summary>
        internal static string UpdateDatabaseSucces {
            get {
                return ResourceManager.GetString("UpdateDatabaseSucces", resourceCulture);
            }
        }
    }
}
